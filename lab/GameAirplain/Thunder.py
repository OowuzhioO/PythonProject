...
class Player(pygame.sprite.Sprite):
    def __init__(self, plane_image, player_rect, init_pos):
        ...
        for i in range(len(player_rect)):
            self.image.append(plane_image.subsurface(player_rect[i]).convert_alpha())
...
backgroud = pygame.image.load('PythonShootGame/resources/image/background.png').convert()
...
while running:
    ...
    for enemy_down in enemies_down:
        ...
        if enemy_down.down_index > 7:
            ...
            score += 1000
            continue
        screen.blit(enemy_down.down_images[enemy_down.down_index // 2], enemy_down.rect)
...
# text = font.render('Score: '+ str(score), True, (256, 0, 0))
